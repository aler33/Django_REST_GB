...
class App extends React.Component {
  ...
  get_token(username, password) {
    axios.post('http://194.67.74.105:8000/api-token-auth/', {username: username,
    password: password})
    .then(response => {
  ...
  load_data() {
    ...
    axios.get('http://194.67.74.105:8000/api/users/', {headers})
      .then(response => {
    ...
    axios.get('http://194.67.74.105:8000/api/todo', {headers})
      .then(response => {
    ...
    axios.get('http://194.67.74.105:8000/api/project', {headers})
      .then(response => {
  ...
  deleteTodo(id) {
    const headers = this.get_headers()
    axios.delete(`http://194.67.74.105:8000/api/todo/${id}`, {headers})
      .then(response => {
  ...
  createTodo(project, user, text) {
      ...
      axios.post(`http://194.67.74.105:8000/api/todo/`, data, {headers})
        .then(response => {
  ...
  deleteProject(id) {
    const headers = this.get_headers()
    axios.delete(`http://194.67.74.105:8000/api/project/${id}`, {headers})
      .then(response => {
  ...
  createProject(name, url, users) {
    ...
    // console.log(data)
    axios.post(`http://194.67.74.105:8000/api/project/`, data, {headers})
      .then(response => {
        // console.log(data)
